...
public class BoardController {
	...
	public void list(Criteria cri, Model model) {
		...
		model.addAttribute("boardlist", service.getListWithPaging(cri));
		model.addAttribute("pageMake", new PageDTO(service.getTotCnt(),cri));
	...
	// 화면에다가 뿌려줘야됨
	public void get(Long id, @ModelAttribute("curPageInfo") Criteria cri,Model model) {
		// 그다음에 서비스 출격io
//		System.out.println("")
